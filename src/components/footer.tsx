    ...
    <footer className="bg-muted border-t border-border mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-semibold text-foreground">HaffNet</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/seminare" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  Alle Seminare
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-border text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} HaffNet. Alle Rechte vorbehalten.</p>
        </div>
      </div>
    </footer>
  )
